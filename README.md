...
| **Sin Evidencias / 0 Chunks (In-Bounds sin datos)** | *¿Qué cursos impartió en la UNAM?* | *"No encontré información específica en la base de conocimiento del CV de Diego sobre esa consulta exacta. 💡 Sugerencias: Puedes probar reformulando tu pregunta o consultar sobre trayectoria, proyectos de IA, habilidades o educación."* | **Guardrail Fail-Loud con Asistencia (Cero Alucinación):** Si se obtienen 0 chunks, el sistema evita alucinar y ofrece alternativas al usuario para reorientar su consulta. |
