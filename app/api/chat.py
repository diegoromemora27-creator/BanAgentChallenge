"""
Router para endpoints de conversación (/chat y /v1/responses).
"""
...
from app.agent.memory import add_message_to_session
...
@router.post("/chat", response_model=ChatResponse, dependencies=[Depends(verify_api_key)], tags=["Agent Chat"])
...
@router.post("/v1/responses", dependencies=[Depends(verify_api_key)], tags=["Open Responses API Standard"])
@router.post("/responses", dependencies=[Depends(verify_api_key)], tags=["Open Responses API Standard"])
@limiter.limit("60/minute")
